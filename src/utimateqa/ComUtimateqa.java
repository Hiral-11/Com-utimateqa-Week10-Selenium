...
public class ComUtimateqa {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        WebElement emaiField = driver.findElement(By.id("user[email]"));
        emaiField.sendKeys("Testing123@gmail.com");
        WebElement passwordField = driver.findElement(By.name("user[password]"));
        passwordField.sendKeys("4569");
        ...
        //Navigate to forward to Home page
